    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white flex items-center justify-center p-4">
      <div className="max-w-lg w-full bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="space-y-3">
            {paymentDetails.tier && (
              <div className="flex justify-between items-center">
                ...
                <span className="font-semibold text-gray-800">{paymentDetails.tier}</span>
              </div>
            )}
            ...
            {paymentDetails.productId && (
              <div className="flex justify-between items-center">
                ...
                <span className="font-mono text-sm text-gray-600">{paymentDetails.productId}</span>
              </div>
            )}
        ...
        <div className="space-y-3">
          ...
          <Link
            href="/"
            className="w-full border-2 border-gray-300 text-gray-700 py-3 px-6 rounded-lg font-semibold hover:bg-gray-50 transition-all duration-200 flex items-center justify-center gap-2"
          >
